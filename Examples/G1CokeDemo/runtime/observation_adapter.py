"""Exact motion-zero physical observation seam for update 2,525.
...
REFERENCE_CONTRACT_SHA256 = "98f12d860335bbaf6e770d626c3fd0efc6bfeff7cb9aad6cae36e296020b41b4"
CONTROL_HZ = 40
...
class FrozenReferenceTimeline:
    """The sealed attempt-000159 reference, advanced exactly once per proposal."""
    ...
    def __init__(
        ...
        *,
        ...
        expected_sha256: str = REFERENCE_CONTRACT_SHA256,
    ) -> None:
...
class ExactEpisodeObservationAdapter:
    ...
    def __init__(self, policy: "CachedReferenceResidualPolicy", bundle: Path) -> None:
        ...
        if not isinstance(sensor, dict) or sensor.get("actor_input_dim") != 316:
            raise ValueError("checkpoint does not contain the exact 316-input contract")
