...
type PruneCacheRequest struct {
	...
	MinAgeSeconds *uint64 `protobuf:"varint,2,opt,name=min_age_seconds,json=minAgeSeconds,proto3,oneof" json:"min_age_seconds,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *PruneCacheRequest) GetMinAgeSeconds() uint64 {
...
func (x *PruneCacheResponse) GetReclaimedBytes() uint64 {
...
const file_wendy_agent_services_v2_container_service_proto_rawDesc = "" +
	"\n" +
	"/wendy/agent/services/v2/container_service.proto\x12\x17wendy.agent.services.v2\x1a$wendy/agent/services/v2/shared.proto\"2\n" +
	...
	"\rstderr_output\x18\x03 \x01(\v2>.wendy.agent.services.v2.ContainerStreamResponse.ConsoleOutputH\x00R\fstderrOutput\x1a\t\n" +
	"\aStarted\x1a#\n" +
	...
	"\x05stats\x18\x01 \x03(\v2'.wendy.agent.services.v2.ContainerStatsR\x05stats\"m\n" +
	"\x11PruneCacheRequest\x12\x17\n" +
	"\adry_run\x18\x01 \x01(\bR\x06dryRun\x12+\n" +
	"\x0fmin_age_seconds\x18\x02 \x01(\x04H\x00R\rminAgeSeconds\x88\x01\x01B\x12\n" +
	"\x10_min_age_seconds\"\x95\x02\n" +
	...
	"\x13minimum_age_seconds\x18\x05 \x01(\x04R\x11minimumAgeSeconds\x12,\n" +
	"\x0freclaimed_bytes\x18\x06 \x01(\x04H\x00R\x0ereclaimedBytes\x88\x01\x01B\x12\n" +
	"\x10_reclaimed_bytes2\x9f\b\n" +
...
var file_wendy_agent_services_v2_container_service_proto_depIdxs = []int32{
	...
	1,  // 7: wendy.agent.services.v2.WendyContainerService.AttachContainer:input_type -> wendy.agent.services.v2.AttachContainerRequest
	3,  // 8: wendy.agent.services.v2.WendyContainerService.StopContainer:input_type -> wendy.agent.services.v2.StopContainerRequest
	5,  // 9: wendy.agent.services.v2.WendyContainerService.DeleteContainer:input_type -> wendy.agent.services.v2.DeleteContainerRequest
	7,  // 10: wendy.agent.services.v2.WendyContainerService.ListContainers:input_type -> wendy.agent.services.v2.ListContainersRequest
...
func file_wendy_agent_services_v2_container_service_proto_init() {
	...
	file_wendy_agent_services_v2_container_service_proto_msgTypes[17].OneofWrappers = []any{}
	file_wendy_agent_services_v2_container_service_proto_msgTypes[18].OneofWrappers = []any{}
	type x struct{}
