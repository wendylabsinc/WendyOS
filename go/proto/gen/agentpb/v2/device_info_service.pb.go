...
type GetDeviceInfoResponse struct {
	...
	HasNpu *bool `protobuf:"varint,18,opt,name=has_npu,json=hasNpu,proto3,oneof" json:"has_npu,omitempty"`
	// NPU vendor identifier (e.g. "qualcomm"). Only present when has_npu is true.
	NpuVendor *string `protobuf:"bytes,19,opt,name=npu_vendor,json=npuVendor,proto3,oneof" json:"npu_vendor,omitempty"`
	...
	GpuCapabilities []*GpuCapabilities `protobuf:"bytes,21,rep,name=gpu_capabilities,json=gpuCapabilities,proto3" json:"gpu_capabilities,omitempty"`
	...
	ContainerStorageDegraded *bool `protobuf:"varint,22,opt,name=container_storage_degraded,json=containerStorageDegraded,proto3,oneof" json:"container_storage_degraded,omitempty"`
	unknownFields            protoimpl.UnknownFields
	sizeCache                protoimpl.SizeCache
}
...
func (x *GetDeviceInfoResponse) GetHasNpu() bool {
...
func (x *GetDeviceInfoResponse) GetNpuVendor() string {
...
func (x *GetDeviceInfoResponse) GetContainerStorage() *DiskPartition {
	if x != nil {
...
func (x *GetDeviceInfoResponse) GetGpuCapabilities() []*GpuCapabilities {
	if x != nil {
...
func (x *GetDeviceInfoResponse) GetContainerStorageDegraded() bool {
...
const file_wendy_agent_services_v2_device_info_service_proto_rawDesc = "" +
	...
	"\tcpu_count\x18\x11 \x01(\rR\bcpuCount\x12\x1c\n" +
	"\ahas_npu\x18\x12 \x01(\bH\n" +
	"R\x06hasNpu\x88\x01\x01\x12\"\n" +
	"\n" +
	...
	"\x10gpu_capabilities\x18\x15 \x03(\v2(.wendy.agent.services.v2.GpuCapabilitiesR\x0fgpuCapabilities\x12A\n" +
	"\x1acontainer_storage_degraded\x18\x16 \x01(\bH\rR\x18containerStorageDegraded\x88\x01\x01B\r\n" +
	"\v_os_versionB\r\n" +
	"\v_public_keyB\x0e\n" +
	"\f_device_typeB\n" +
	"\n" +
	...
	"\x1b_container_storage_degraded\"\xa7\x01\n" +
	...
	"\x04path\x18\x03 \x01(\tR\x04path2\x9a\x02\n" +
...
var file_wendy_agent_services_v2_device_info_service_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_wendy_agent_services_v2_device_info_service_proto_goTypes = []any{
	...
	(*GpuCapabilities)(nil),                                     // 5: wendy.agent.services.v2.GpuCapabilities
	(*ListHardwareCapabilitiesResponse_HardwareCapability)(nil), // 6: wendy.agent.services.v2.ListHardwareCapabilitiesResponse.HardwareCapability
	nil, // 7: wendy.agent.services.v2.ListHardwareCapabilitiesResponse.HardwareCapability.PropertiesEntry
}
var file_wendy_agent_services_v2_device_info_service_proto_depIdxs = []int32{
	...
	2, // 1: wendy.agent.services.v2.GetDeviceInfoResponse.container_storage:type_name -> wendy.agent.services.v2.DiskPartition
	5, // 2: wendy.agent.services.v2.GetDeviceInfoResponse.gpu_capabilities:type_name -> wendy.agent.services.v2.GpuCapabilities
	6, // 3: wendy.agent.services.v2.ListHardwareCapabilitiesResponse.capabilities:type_name -> wendy.agent.services.v2.ListHardwareCapabilitiesResponse.HardwareCapability
	7, // 4: wendy.agent.services.v2.ListHardwareCapabilitiesResponse.HardwareCapability.properties:type_name -> wendy.agent.services.v2.ListHardwareCapabilitiesResponse.HardwareCapability.PropertiesEntry
	...
	1, // 7: wendy.agent.services.v2.WendyDeviceInfoService.GetDeviceInfo:output_type -> wendy.agent.services.v2.GetDeviceInfoResponse
	4, // 8: wendy.agent.services.v2.WendyDeviceInfoService.ListHardwareCapabilities:output_type -> wendy.agent.services.v2.ListHardwareCapabilitiesResponse
