...
func (x *GetAgentVersionResponse) GetContainerStorage() *DiskPartition {
	if x != nil {
...
type DiscoveredBluetoothPeripheral struct {
	...
	// Effective BLE link supervision timeout, for a connected LE peripheral
	// the agent tracks. Absent when not connected, Classic, or an older agent.
	SupervisionTimeoutMs *uint32 `protobuf:"varint,8,opt,name=supervision_timeout_ms,json=supervisionTimeoutMs,proto3,oneof" json:"supervision_timeout_ms,omitempty"`
	// What the peripheral asked for when that was above the agent's target.
	// Equal to supervision_timeout_ms once the agent stopped overriding it.
	RequestedSupervisionTimeoutMs *uint32 `protobuf:"varint,9,opt,name=requested_supervision_timeout_ms,json=requestedSupervisionTimeoutMs,proto3,oneof" json:"requested_supervision_timeout_ms,omitempty"`
	unknownFields                 protoimpl.UnknownFields
	sizeCache                     protoimpl.SizeCache
}
...
func (x *DiscoveredBluetoothPeripheral) GetSupervisionTimeoutMs() uint32 {
	if x != nil && x.SupervisionTimeoutMs != nil {
		return *x.SupervisionTimeoutMs
	}
	return 0
}

func (x *DiscoveredBluetoothPeripheral) GetRequestedSupervisionTimeoutMs() uint32 {
	if x != nil && x.RequestedSupervisionTimeoutMs != nil {
		return *x.RequestedSupervisionTimeoutMs
	}
	return 0
}
...
func (*GpuCapabilities) Descriptor() ([]byte, []int) {
	return file_wendy_agent_services_v1_wendy_agent_v1_service_proto_rawDescGZIP(), []int{46}
}

func (x *GpuCapabilities) GetComputeBackends() []string {
	if x != nil {
		return x.ComputeBackends
	}
	return nil
}
...
func (x *GpuCapabilities) GetPath() string {
	if x != nil {
		return x.Path
	}
	return ""
...
func (x *GetOSUpdateStatusResponse_ServiceResult) Reset() {
	*x = GetOSUpdateStatusResponse_ServiceResult{}
	mi := &file_wendy_agent_services_v1_wendy_agent_v1_service_proto_msgTypes[69]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
const file_wendy_agent_services_v1_wendy_agent_v1_service_proto_rawDesc = "" +
	...
	"\x1fScanBluetoothPeripheralsRequest\"\x9a\x03\n" +
	...
	"\atrusted\x18\a \x01(\bR\atrusted\x129\n" +
	"\x16supervision_timeout_ms\x18\b \x01(\rH\x00R\x14supervisionTimeoutMs\x88\x01\x01\x12L\n" +
	" requested_supervision_timeout_ms\x18\t \x01(\rH\x01R\x1drequestedSupervisionTimeoutMs\x88\x01\x01B\x19\n" +
	"\x17_supervision_timeout_msB#\n" +
	"!_requested_supervision_timeout_ms\"\x89\x01\n" +
	...
	"\x0fGpuCapabilities\x12)\n" +
	"\x10compute_backends\x18\x01 \x03(\tR\x0fcomputeBackends\x12\x16\n" +
...
var file_wendy_agent_services_v1_wendy_agent_v1_service_proto_msgTypes = make([]protoimpl.MessageInfo, 70)
var file_wendy_agent_services_v1_wendy_agent_v1_service_proto_goTypes = []any{
	...
	(*GpuCapabilities)(nil),                                     // 49: wendy.agent.services.v1.GpuCapabilities
	(*RunContainerRequest_Header)(nil),                          // 50: wendy.agent.services.v1.RunContainerRequest.Header
	(*RunContainerRequest_Chunk)(nil),                           // 51: wendy.agent.services.v1.RunContainerRequest.Chunk
	(*ControlCommand_Run)(nil),                                  // 52: wendy.agent.services.v1.ControlCommand.Run
	(*ControlCommand_Stop)(nil),                                 // 53: wendy.agent.services.v1.ControlCommand.Stop
	(*RunContainerResponse_Started)(nil),                        // 54: wendy.agent.services.v1.RunContainerResponse.Started
	(*RunContainerResponse_Stopped)(nil),                        // 55: wendy.agent.services.v1.RunContainerResponse.Stopped
	(*RunContainerResponse_ConsoleOutput)(nil),                  // 56: wendy.agent.services.v1.RunContainerResponse.ConsoleOutput
	(*UpdateAgentRequest_Chunk)(nil),                            // 57: wendy.agent.services.v1.UpdateAgentRequest.Chunk
	(*UpdateAgentRequest_ControlCommand)(nil),                   // 58: wendy.agent.services.v1.UpdateAgentRequest.ControlCommand
	(*UpdateAgentRequest_ControlCommand_Update)(nil),            // 59: wendy.agent.services.v1.UpdateAgentRequest.ControlCommand.Update
	(*UpdateAgentResponse_Updated)(nil),                         // 60: wendy.agent.services.v1.UpdateAgentResponse.Updated
	(*ListWiFiNetworksResponse_WiFiNetwork)(nil),                // 61: wendy.agent.services.v1.ListWiFiNetworksResponse.WiFiNetwork
	(*ListKnownWiFiNetworksResponse_KnownWiFiNetwork)(nil),      // 62: wendy.agent.services.v1.ListKnownWiFiNetworksResponse.KnownWiFiNetwork
	(*ListHardwareCapabilitiesResponse_HardwareCapability)(nil), // 63: wendy.agent.services.v1.ListHardwareCapabilitiesResponse.HardwareCapability
	nil,                                        // 64: wendy.agent.services.v1.ListHardwareCapabilitiesResponse.HardwareCapability.PropertiesEntry
	(*UpdateOSResponse_Progress)(nil),          // 65: wendy.agent.services.v1.UpdateOSResponse.Progress
	(*UpdateOSResponse_Completed)(nil),         // 66: wendy.agent.services.v1.UpdateOSResponse.Completed
	(*UpdateOSResponse_Failed)(nil),            // 67: wendy.agent.services.v1.UpdateOSResponse.Failed
	(*OSUpdateEngineStatus_Slot)(nil),          // 68: wendy.agent.services.v1.OSUpdateEngineStatus.Slot
	(*OSUpdateEngineStatus_SystemEntry)(nil),   // 69: wendy.agent.services.v1.OSUpdateEngineStatus.SystemEntry
	(*OSUpdateEngineStatus_PendingUpdate)(nil), // 70: wendy.agent.services.v1.OSUpdateEngineStatus.PendingUpdate
	nil, // 71: wendy.agent.services.v1.OSUpdateEngineStatus.DiagnosticsEntry
	(*GetOSUpdateStatusResponse_ServiceResult)(nil), // 72: wendy.agent.services.v1.GetOSUpdateStatusResponse.ServiceResult
	(*BatteryStats)(nil),                            // 73: BatteryStats
	(*RestartPolicy)(nil),                           // 74: RestartPolicy
}
var file_wendy_agent_services_v1_wendy_agent_v1_service_proto_depIdxs = []int32{
	50, // 0: wendy.agent.services.v1.RunContainerRequest.header:type_name -> wendy.agent.services.v1.RunContainerRequest.Header
	51, // 1: wendy.agent.services.v1.RunContainerRequest.chunk:type_name -> wendy.agent.services.v1.RunContainerRequest.Chunk
	4,  // 2: wendy.agent.services.v1.RunContainerRequest.control:type_name -> wendy.agent.services.v1.ControlCommand
	52, // 3: wendy.agent.services.v1.ControlCommand.run:type_name -> wendy.agent.services.v1.ControlCommand.Run
	53, // 4: wendy.agent.services.v1.ControlCommand.stop:type_name -> wendy.agent.services.v1.ControlCommand.Stop
	54, // 5: wendy.agent.services.v1.RunContainerResponse.started:type_name -> wendy.agent.services.v1.RunContainerResponse.Started
	55, // 6: wendy.agent.services.v1.RunContainerResponse.stopped:type_name -> wendy.agent.services.v1.RunContainerResponse.Stopped
	56, // 7: wendy.agent.services.v1.RunContainerResponse.stdout_output:type_name -> wendy.agent.services.v1.RunContainerResponse.ConsoleOutput
	56, // 8: wendy.agent.services.v1.RunContainerResponse.stderr_output:type_name -> wendy.agent.services.v1.RunContainerResponse.ConsoleOutput
	57, // 9: wendy.agent.services.v1.UpdateAgentRequest.chunk:type_name -> wendy.agent.services.v1.UpdateAgentRequest.Chunk
	58, // 10: wendy.agent.services.v1.UpdateAgentRequest.control:type_name -> wendy.agent.services.v1.UpdateAgentRequest.ControlCommand
	60, // 11: wendy.agent.services.v1.UpdateAgentResponse.updated:type_name -> wendy.agent.services.v1.UpdateAgentResponse.Updated
	...
	73, // 14: wendy.agent.services.v1.GetAgentVersionResponse.battery:type_name -> BatteryStats
	11, // 15: wendy.agent.services.v1.GetAgentVersionResponse.container_storage:type_name -> wendy.agent.services.v1.DiskPartition
	49, // 16: wendy.agent.services.v1.GetAgentVersionResponse.gpu_capabilities:type_name -> wendy.agent.services.v1.GpuCapabilities
	61, // 17: wendy.agent.services.v1.ListWiFiNetworksResponse.networks:type_name -> wendy.agent.services.v1.ListWiFiNetworksResponse.WiFiNetwork
	0,  // 18: wendy.agent.services.v1.ConnectToWiFiRequest.security:type_name -> wendy.agent.services.v1.WiFiSecurityType
	62, // 19: wendy.agent.services.v1.ListKnownWiFiNetworksResponse.networks:type_name -> wendy.agent.services.v1.ListKnownWiFiNetworksResponse.KnownWiFiNetwork
	63, // 20: wendy.agent.services.v1.ListHardwareCapabilitiesResponse.capabilities:type_name -> wendy.agent.services.v1.ListHardwareCapabilitiesResponse.HardwareCapability
	31, // 21: wendy.agent.services.v1.ScanBluetoothPeripheralsResponse.discovered_devices:type_name -> wendy.agent.services.v1.DiscoveredBluetoothPeripheral
	65, // 22: wendy.agent.services.v1.UpdateOSResponse.progress:type_name -> wendy.agent.services.v1.UpdateOSResponse.Progress
	66, // 23: wendy.agent.services.v1.UpdateOSResponse.completed:type_name -> wendy.agent.services.v1.UpdateOSResponse.Completed
	67, // 24: wendy.agent.services.v1.UpdateOSResponse.failed:type_name -> wendy.agent.services.v1.UpdateOSResponse.Failed
	43, // 25: wendy.agent.services.v1.DumpKernelLogResponse.records:type_name -> wendy.agent.services.v1.KernelLogRecord
	68, // 26: wendy.agent.services.v1.OSUpdateEngineStatus.slots:type_name -> wendy.agent.services.v1.OSUpdateEngineStatus.Slot
	69, // 27: wendy.agent.services.v1.OSUpdateEngineStatus.system:type_name -> wendy.agent.services.v1.OSUpdateEngineStatus.SystemEntry
	70, // 28: wendy.agent.services.v1.OSUpdateEngineStatus.pending:type_name -> wendy.agent.services.v1.OSUpdateEngineStatus.PendingUpdate
	71, // 29: wendy.agent.services.v1.OSUpdateEngineStatus.diagnostics:type_name -> wendy.agent.services.v1.OSUpdateEngineStatus.DiagnosticsEntry
	1,  // 30: wendy.agent.services.v1.GetOSUpdateStatusResponse.outcome:type_name -> wendy.agent.services.v1.GetOSUpdateStatusResponse.Outcome
	72, // 31: wendy.agent.services.v1.GetOSUpdateStatusResponse.services:type_name -> wendy.agent.services.v1.GetOSUpdateStatusResponse.ServiceResult
	45, // 32: wendy.agent.services.v1.GetOSUpdateStatusResponse.engine_status:type_name -> wendy.agent.services.v1.OSUpdateEngineStatus
	74, // 33: wendy.agent.services.v1.ControlCommand.Run.restart_policy:type_name -> RestartPolicy
	59, // 34: wendy.agent.services.v1.UpdateAgentRequest.ControlCommand.update:type_name -> wendy.agent.services.v1.UpdateAgentRequest.ControlCommand.Update
	0,  // 35: wendy.agent.services.v1.ListWiFiNetworksResponse.WiFiNetwork.security:type_name -> wendy.agent.services.v1.WiFiSecurityType
	0,  // 36: wendy.agent.services.v1.ListKnownWiFiNetworksResponse.KnownWiFiNetwork.security:type_name -> wendy.agent.services.v1.WiFiSecurityType
	64, // 37: wendy.agent.services.v1.ListHardwareCapabilitiesResponse.HardwareCapability.properties:type_name -> wendy.agent.services.v1.ListHardwareCapabilitiesResponse.HardwareCapability.PropertiesEntry
	2,  // 38: wendy.agent.services.v1.GetOSUpdateStatusResponse.ServiceResult.status:type_name -> wendy.agent.services.v1.GetOSUpdateStatusResponse.ServiceResult.Status
	3,  // 39: wendy.agent.services.v1.WendyAgentService.RunContainer:input_type -> wendy.agent.services.v1.RunContainerRequest
	6,  // 40: wendy.agent.services.v1.WendyAgentService.UpdateAgent:input_type -> wendy.agent.services.v1.UpdateAgentRequest
	8,  // 41: wendy.agent.services.v1.WendyAgentService.GetAgentVersion:input_type -> wendy.agent.services.v1.GetAgentVersionRequest
	12, // 42: wendy.agent.services.v1.WendyAgentService.ListWiFiNetworks:input_type -> wendy.agent.services.v1.ListWiFiNetworksRequest
	14, // 43: wendy.agent.services.v1.WendyAgentService.ConnectToWiFi:input_type -> wendy.agent.services.v1.ConnectToWiFiRequest
	16, // 44: wendy.agent.services.v1.WendyAgentService.GetWiFiStatus:input_type -> wendy.agent.services.v1.GetWiFiStatusRequest
	18, // 45: wendy.agent.services.v1.WendyAgentService.DisconnectWiFi:input_type -> wendy.agent.services.v1.DisconnectWiFiRequest
	20, // 46: wendy.agent.services.v1.WendyAgentService.ListKnownWiFiNetworks:input_type -> wendy.agent.services.v1.ListKnownWiFiNetworksRequest
	22, // 47: wendy.agent.services.v1.WendyAgentService.SetWiFiNetworkPriority:input_type -> wendy.agent.services.v1.SetWiFiNetworkPriorityRequest
	24, // 48: wendy.agent.services.v1.WendyAgentService.ReorderKnownWiFiNetworks:input_type -> wendy.agent.services.v1.ReorderKnownWiFiNetworksRequest
	26, // 49: wendy.agent.services.v1.WendyAgentService.ForgetWiFiNetwork:input_type -> wendy.agent.services.v1.ForgetWiFiNetworkRequest
	28, // 50: wendy.agent.services.v1.WendyAgentService.ListHardwareCapabilities:input_type -> wendy.agent.services.v1.ListHardwareCapabilitiesRequest
	30, // 51: wendy.agent.services.v1.WendyAgentService.ScanBluetoothPeripherals:input_type -> wendy.agent.services.v1.ScanBluetoothPeripheralsRequest
	33, // 52: wendy.agent.services.v1.WendyAgentService.ConnectBluetoothPeripheral:input_type -> wendy.agent.services.v1.ConnectBluetoothPeripheralRequest
	35, // 53: wendy.agent.services.v1.WendyAgentService.DisconnectBluetoothPeripheral:input_type -> wendy.agent.services.v1.DisconnectBluetoothPeripheralRequest
	37, // 54: wendy.agent.services.v1.WendyAgentService.ForgetBluetoothPeripheral:input_type -> wendy.agent.services.v1.ForgetBluetoothPeripheralRequest
	39, // 55: wendy.agent.services.v1.WendyAgentService.UpdateOS:input_type -> wendy.agent.services.v1.UpdateOSRequest
	41, // 56: wendy.agent.services.v1.WendyAgentService.DumpKernelLog:input_type -> wendy.agent.services.v1.DumpKernelLogRequest
	44, // 57: wendy.agent.services.v1.WendyAgentService.GetOSUpdateStatus:input_type -> wendy.agent.services.v1.GetOSUpdateStatusRequest
	47, // 58: wendy.agent.services.v1.WendyAgentService.SetHostname:input_type -> wendy.agent.services.v1.SetHostnameRequest
	5,  // 59: wendy.agent.services.v1.WendyAgentService.RunContainer:output_type -> wendy.agent.services.v1.RunContainerResponse
	7,  // 60: wendy.agent.services.v1.WendyAgentService.UpdateAgent:output_type -> wendy.agent.services.v1.UpdateAgentResponse
	9,  // 61: wendy.agent.services.v1.WendyAgentService.GetAgentVersion:output_type -> wendy.agent.services.v1.GetAgentVersionResponse
	13, // 62: wendy.agent.services.v1.WendyAgentService.ListWiFiNetworks:output_type -> wendy.agent.services.v1.ListWiFiNetworksResponse
	15, // 63: wendy.agent.services.v1.WendyAgentService.ConnectToWiFi:output_type -> wendy.agent.services.v1.ConnectToWiFiResponse
	17, // 64: wendy.agent.services.v1.WendyAgentService.GetWiFiStatus:output_type -> wendy.agent.services.v1.GetWiFiStatusResponse
	19, // 65: wendy.agent.services.v1.WendyAgentService.DisconnectWiFi:output_type -> wendy.agent.services.v1.DisconnectWiFiResponse
	21, // 66: wendy.agent.services.v1.WendyAgentService.ListKnownWiFiNetworks:output_type -> wendy.agent.services.v1.ListKnownWiFiNetworksResponse
	23, // 67: wendy.agent.services.v1.WendyAgentService.SetWiFiNetworkPriority:output_type -> wendy.agent.services.v1.SetWiFiNetworkPriorityResponse
	25, // 68: wendy.agent.services.v1.WendyAgentService.ReorderKnownWiFiNetworks:output_type -> wendy.agent.services.v1.ReorderKnownWiFiNetworksResponse
	27, // 69: wendy.agent.services.v1.WendyAgentService.ForgetWiFiNetwork:output_type -> wendy.agent.services.v1.ForgetWiFiNetworkResponse
	29, // 70: wendy.agent.services.v1.WendyAgentService.ListHardwareCapabilities:output_type -> wendy.agent.services.v1.ListHardwareCapabilitiesResponse
	32, // 71: wendy.agent.services.v1.WendyAgentService.ScanBluetoothPeripherals:output_type -> wendy.agent.services.v1.ScanBluetoothPeripheralsResponse
	34, // 72: wendy.agent.services.v1.WendyAgentService.ConnectBluetoothPeripheral:output_type -> wendy.agent.services.v1.ConnectBluetoothPeripheralResponse
	36, // 73: wendy.agent.services.v1.WendyAgentService.DisconnectBluetoothPeripheral:output_type -> wendy.agent.services.v1.DisconnectBluetoothPeripheralResponse
	38, // 74: wendy.agent.services.v1.WendyAgentService.ForgetBluetoothPeripheral:output_type -> wendy.agent.services.v1.ForgetBluetoothPeripheralResponse
	40, // 75: wendy.agent.services.v1.WendyAgentService.UpdateOS:output_type -> wendy.agent.services.v1.UpdateOSResponse
	42, // 76: wendy.agent.services.v1.WendyAgentService.DumpKernelLog:output_type -> wendy.agent.services.v1.DumpKernelLogResponse
	46, // 77: wendy.agent.services.v1.WendyAgentService.GetOSUpdateStatus:output_type -> wendy.agent.services.v1.GetOSUpdateStatusResponse
	48, // 78: wendy.agent.services.v1.WendyAgentService.SetHostname:output_type -> wendy.agent.services.v1.SetHostnameResponse
...
func file_wendy_agent_services_v1_wendy_agent_v1_service_proto_init() {
	...
	file_wendy_agent_services_v1_wendy_agent_v1_service_proto_msgTypes[28].OneofWrappers = []any{}
	...
	file_wendy_agent_services_v1_wendy_agent_v1_service_proto_msgTypes[58].OneofWrappers = []any{}
	type x struct{}
