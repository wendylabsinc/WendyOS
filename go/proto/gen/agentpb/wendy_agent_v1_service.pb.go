...
type GetAgentVersionResponse struct {
	...
	ContainerStorageDegraded *bool `protobuf:"varint,27,opt,name=container_storage_degraded,json=containerStorageDegraded,proto3,oneof" json:"container_storage_degraded,omitempty"`
	unknownFields            protoimpl.UnknownFields
	sizeCache                protoimpl.SizeCache
}
...
const file_wendy_agent_services_v1_wendy_agent_v1_service_proto_rawDesc = "" +
	...
	"\aUpdatedB\x0f\n" +
	"\rresponse_type\"\x18\n" +
	"\x16GetAgentVersionRequest\"\xd9\v\n" +
	...
	"\x10gpu_capabilities\x18\x1a \x03(\v2(.wendy.agent.services.v1.GpuCapabilitiesR\x0fgpuCapabilities\x12A\n" +
	"\x1acontainer_storage_degraded\x18\x1b \x01(\bH\x0fR\x18containerStorageDegraded\x88\x01\x01B\r\n" +
	"\v_os_versionB\r\n" +
	"\v_public_keyB\x0e\n" +
	"\f_device_typeB\n" +
	"\n" +
