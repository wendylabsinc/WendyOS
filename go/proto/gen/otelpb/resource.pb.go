...
type Resource struct {
	...
	//
	// Status: [Development]
	EntityRefs    []*EntityRef `protobuf:"bytes,3,rep,name=entity_refs,json=entityRefs,proto3" json:"entity_refs,omitempty"`
...
func (x *Resource) GetEntityRefs() []*EntityRef {
	if x != nil {
		return x.EntityRefs
	}
	return nil
...
var file_opentelemetry_proto_resource_v1_resource_proto_goTypes = []any{
	...
	(*KeyValue)(nil),  // 1: opentelemetry.proto.common.v1.KeyValue
	(*EntityRef)(nil), // 2: opentelemetry.proto.common.v1.EntityRef
}
