...
export class SandboxViewer {
  constructor(canvas, status) {
    ...
    this.camera.position.set(2.4, -2.7, 1.8);
    ...
    const grid = new THREE.GridHelper(12, 24, 0x566169, 0x37434b);
  ...
  resetView() {
    ...
    this.camera.position.copy(target).add(new THREE.Vector3(2.4, -2.7, 1.5));
    this.controls.update();
  }
