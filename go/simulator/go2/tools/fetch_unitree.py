...
Run --check for offline validation. Output paths are relative to the Go2
...
def main() -> int:
    ...
    parser.add_argument("--output-dir", type=Path, default=ROOT, help="Go2 project root for all manifest destinations")
