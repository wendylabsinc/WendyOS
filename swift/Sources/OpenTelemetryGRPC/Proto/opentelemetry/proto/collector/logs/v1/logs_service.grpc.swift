...
public enum Opentelemetry_Proto_Collector_Logs_V1_LogsService: Sendable {
    /// Service descriptor for the "opentelemetry.proto.collector.logs.v1.LogsService" service.
    public static let descriptor = GRPCCore.ServiceDescriptor(fullyQualifiedService: "opentelemetry.proto.collector.logs.v1.LogsService")
    /// Namespace for method metadata.
    public enum Method: Sendable {
        /// Namespace for "Export" metadata.
        public enum Export: Sendable {
            /// Request type for "Export".
            public typealias Input = Opentelemetry_Proto_Collector_Logs_V1_ExportLogsServiceRequest
            /// Response type for "Export".
            public typealias Output = Opentelemetry_Proto_Collector_Logs_V1_ExportLogsServiceResponse
...
extension GRPCCore.ServiceDescriptor {
    /// Service descriptor for the "opentelemetry.proto.collector.logs.v1.LogsService" service.
    public static let opentelemetry_proto_collector_logs_v1_LogsService = GRPCCore.ServiceDescriptor(fullyQualifiedService: "opentelemetry.proto.collector.logs.v1.LogsService")
}
...
extension Opentelemetry_Proto_Collector_Logs_V1_LogsService {
    ...
    /// > OpenTelemetry and an collector, or between an collector and a central collector (in this
    /// > case logs are sent/received to/from multiple Applications).
    public protocol ServiceProtocol: Opentelemetry_Proto_Collector_Logs_V1_LogsService.StreamingServiceProtocol {
        /// Handle the "Export" method.
        ///
        /// - Parameters:
    ...
    /// > OpenTelemetry and an collector, or between an collector and a central collector (in this
    /// > case logs are sent/received to/from multiple Applications).
    public protocol SimpleServiceProtocol: Opentelemetry_Proto_Collector_Logs_V1_LogsService.ServiceProtocol {
        /// Handle the "Export" method.
        ///
        /// - Parameters:
